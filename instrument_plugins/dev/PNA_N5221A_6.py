...
# --------------------------------------
    ...
    def setup(self,measurement_type='S12', measurement_format = 'MLOG', start_frequency=1.5e9,stop_frequency=8.5e9, sweeppoints=2000,bandwidth=1e6):
        '''
    ...
    def add_trace(self, measurement_type='S11', measurement_format='POLAR',new_channel=True, display=True, new_window=True):
        '''
        ...
        self._secondary_trace_list.append([channel_nr,trace_nr,str(trace_nr),measurement_type, window_nr,measurement_format])
