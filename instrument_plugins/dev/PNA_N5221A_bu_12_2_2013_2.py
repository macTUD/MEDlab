...
# --------------------------------------
    ...
    def single_window(self,measurename='MyMeas1', reset=False):
        '''
        ...
        self._visainstrument.write("DISPlay:WINDow1:STATE ON")
        #Create and turn on window/channel 1
        string = 'CALCulate1:PARameter:DEFine:EXT ' +"'"+ measurename + "'"+',S21'
        print string
        self._visainstrument.write(string)
        #Define a measurement name, parameter
        string = 'DISPlay:WINDow1:TRACe1:FEED ' +"'" + measurename + "'"
        print string
        self._visainstrument.write(string)
    ...
    def save_settings(self,settingsname):
        ...
        self._visainstrument.write('MMEM:STOR:STA
