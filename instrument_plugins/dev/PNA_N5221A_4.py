...
# --------------------------------------
    ...
    def fetch_data(self, channel=1, trace_number=1, polar=False):
        ...
        if(polar==False):
            ...
            return self.parse_trace(tr,complex_rep=True)
