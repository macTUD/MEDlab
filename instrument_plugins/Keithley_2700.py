...
class Keithley_2700(Instrument):
    ...
    def __init__(self, name, address, reset=False,
        ...
        self.add_parameter('autorange',
            ...
            units='',
            type=types.BooleanType)
        self.add_parameter('IVVI_gain',         
            flags=Instrument.FLAG_GETSET,
            units='MV/A or V/V', curryes=True,type=types.FloatType) #added by Harold
...
# --------------------------------------
    ...
    def do_set_IVVI_gain(self, value):
        self.set_parameter_options('IVVI_gain',value=float(value))

    def do_get_IVVI_gain(self):
        a=self.get_parameter_options('IVVI_gain')
        return a['value']
