...
filename = 'S21_pow_Vg_CNT-JLC-1to9rough0gate'
...
data.create_file()
data.copy_file('bf-s21-pow-vg_v6.py')
...
f1_stop= 9*GHz
f1_pts = 32001
f1_bw = 10*kHz #float(f1_stop-f1_start)/float(f1_pts) #500e3#1e9/180e3 #expected q factor
