...
data.create_file()
data.copy_file('bf-s21-pow-fset_300um_v4.py')
...
#hanger_idx = hanger_idx+5.52*1e9
#200um hangers
...
hanger_span = 2*MHz #this is the span for each cent. freq.
f1_pts = 2000
f1_bw = 30         #float(f1_stop-f1_start)/float(f1_pts) #500e3#1e9/180e3 #expected q factor
