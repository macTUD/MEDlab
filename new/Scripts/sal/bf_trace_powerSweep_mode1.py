...
GHz=1000
start_frequency= 5.850*GHz
stop_frequency= 5.950*GHz
sweep_points =1000+1

#FSL18 instrument variables
kHz=0.001
fsl_bandwidth = 0.1*kHz#MHz
...
med.set_device('BigWafer4_mix')
med.set_setup('BF Brightside')
med.set_user('Vibhor')
...
data.create_file()
data.copy_file('bf_trace_powerSweep_mode1.py')
