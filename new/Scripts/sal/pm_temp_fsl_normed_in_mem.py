#Measurment script for the FSL & Rigol temperature measurement
#using the Poorman's dipstick with normalization in the memory of python
...
#Set up data
filename = 'pm_temp_fsl_normed_in_mem'
...
data.create_file()
data.copy_file('pm_temp_fsl_normed_in_mem.py')
...
plot=qt.Plot2D(data, name=filename, coorddim=0, valdim=2) #creates bugs
