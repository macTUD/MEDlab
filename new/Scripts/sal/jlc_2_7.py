...
GHz=1000
start_frequency= 2*GHz
stop_frequency= 12*GHz
sweep_points =2000+1
...
med.set_device('JLC_2_7um')
med.set_setup('4K poorman')
med.set_user('Ben & Vibhor')
...
#Set up data
filename = 'jlc_2_7_normalization'
