...
zvb.set_averages(aver)
wait_time=zvb.get_sweeptime()*aver
...
#Set up data
filename = 'bf_vna_hres_wait_avg_and_grab.py'
...
data.create_file()
data.copy_file('bf_vna_hres_wait_avg_and_grab.py')
