...
GHz=1000
start_frequency= 5.310*GHz
stop_frequency= 5.410*GHz
sweep_points =1000+1
...
med.set_device('BigWafer1_50Ohm_again')
...
data.create_file()
data.copy_file('bf_trace_mode4.py')
